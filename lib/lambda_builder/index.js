...
lambdaBuilder.prototype.deploy = function(pathToLambda) {
  ...
  var buffer = null;
  // @TODO extract name from file path instead of config
  ...
  return getPackageBuffer(pathToLambda, config.packageContent)
...
/* istanbul ignore next */
/**
 * Retrieve a role Arn form a identifier that can be either the ARN or the name
